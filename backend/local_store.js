...
const SEED_DATA = {
  ...
  tipe_surat: [
    { buku_kode: "PR", kode: "01.01", nama: "Kebijakan Perencanaan" },
    { buku_kode: "PR", kode: "01.02", nama: "Program dan Anggaran" },
    { buku_kode: "KU", kode: "02.01", nama: "Kebijakan Keuangan" },
    { buku_kode: "KU", kode: "02.02", nama: "Perbendaharaan" },
    { buku_kode: "OT", kode: "03.01", nama: "Kelembagaan" },
    { buku_kode: "OT", kode: "03.02", nama: "Ketatalaksanaan" },
    { buku_kode: "SA", kode: "04.01", nama: "Formasi dan Pengadaan" },
    { buku_kode: "SA", kode: "04.02", nama: "Mutasi dan Promosi" },
    { buku_kode: "PB", kode: "05.01", nama: "Perencanaan Kebutuhan" },
    { buku_kode: "PB", kode: "05.02", nama: "Pengadaan BMN" },
    { buku_kode: "UM", kode: "06.01", nama: "Tata Usaha" },
    { buku_kode: "UM", kode: "06.02", nama: "Rumah Tangga" },
    { buku_kode: "PW", kode: "07.01", nama: "Kebijakan Pengawasan" },
    { buku_kode: "PW", kode: "07.02", nama: "Audit Internal" },
    { buku_kode: "PK", kode: "08.01", nama: "Pembinaan Narapidana" },
    { buku_kode: "PK", kode: "08.02", nama: "Keamanan dan Ketertiban" },
  ],
  masuk: [],
  surat_keluar: [],
};
